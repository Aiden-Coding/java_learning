...
public class Result<T> {
    ...
    private Result(String status, String message,int rowCount, T data) {
        this.status = status;
     ...
     * @return 结构数据
     */
    public static <T> Result<T> buildResult(Status status, String message,int rowCount, T data) {
